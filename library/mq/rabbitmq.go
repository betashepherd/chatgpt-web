...
//	route := ""
//	name := "job_queue"
//	addr := "amqp://root:123456@172.18.10.27:30672/"
//	queue := New(exchange, route, name, addr)
...
func createRabbitMqConn(exchange, route, name string, addr string) *Session {
	session := Session{
...
var RabbitMQ *Session

func InitRabbitMQ() {
	//RabbitMQ = createRabbitMqConn(rabbitMQ.Exchange, rabbitMQ.Route, rabbitMQ.Queue, rabbitMQ.Addr)
}
